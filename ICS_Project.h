...
#define RED 31 //Red
#define GRN 32 //Green
#define YEL 33 //Yellow
#define BLU 34 //Blue
#define MAG 35 //Magenta
#define CYN 36 //Cyan
#define WHT 37 //White

#define REGU 0 //Regular
#define BOLD 1 //Bold
#define UNDL 4 //Underlined
#define HIB 0  //High Intensity Background
#define HIT 0  //High Intensity Text
#define BHT 1  //Bold High Intensity Text
